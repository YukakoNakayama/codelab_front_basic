...
var date2 = new Date(2025,4,3,10,0);
var ms1 = day.getTime();
var ms2 = date2.getTime();
var date_diff = ms2 - ms1;
var diff = Math.ceil(date_diff/(1000*60*60*24));

console.log(ms1);
console.log(date_diff);
console.log("大阪万博まであと" + diff + "日");
...
var count = function(){
  console.log(num2++);
  var time = setTimeout(count,2000);
  if(num2 > 5) {
    clearTimeout(time);
  }
}
